...
class DatasetGenerator(ChessGame):
    def __init__(self, board, max_depth=4, time_limit=1, isBlackAI=False, isWhiteAI=False, isBlackStockfishAI=True, isWhiteStockfishAI=True, random_move_chance=0.1):
